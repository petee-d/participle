...
import (
	...
	"github.com/alecthomas/participle/v2/generated"
...
func TestGenerated(t *testing.T) {
	...
	require.NoError(t, generated.ParseStuff(lexNew, &stuffNew, false))
	fmt.Printf("%+v\n", &stuffNew)
...
func BenchmarkGenerated(b *testing.B) {
	...
	for i := 0; i < b.N; i++ {
		...
		lexCopy := lex.Clone()
		if err := generated.ParseStuff(lexCopy, &stuff, false); err != nil {
			require.NoError(b, err)
		}
		//os.Exit(0)
	}
